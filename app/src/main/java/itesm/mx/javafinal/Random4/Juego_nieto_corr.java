...
package itesm.mx.javafinal.Random4;
...
import itesm.mx.javafinal.Random10.Juego_calabaza;
import itesm.mx.javafinal.Random11.Juego_carne;
import itesm.mx.javafinal.Random2.Juego_1_corr;
import itesm.mx.javafinal.Random3.Juego_blanco_corr;
import itesm.mx.javafinal.Random5.Juego_tigre_corr;
import itesm.mx.javafinal.Random7.Juego_perro;
import itesm.mx.javafinal.Random8.Juego_vaca;
import itesm.mx.javafinal.Random9.Juego_abril;
import itesm.mx.javafinal.juegoaleatorio.Juego_0_corr;


public class Juego_nieto_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_nieto);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.nieto);
        ...
        button_corr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (numero == 1) {
                    Intent o = new Intent(getApplicationContext(), Juego_0_corr.class);
                    startActivity(o);
                } else if (numero == 2) {
                    Intent o = new Intent(getApplicationContext(), Juego_1_corr.class);
                    startActivity(o);
                } else if (numero == 3) {
                    Intent o = new Intent(getApplicationContext(), Juego_blanco_corr.class);
                    startActivity(o);

                } else if (numero == 4) {
                    Intent o = new Intent(getApplicationContext(), Juego_pan_corr.class);
                    startActivity(o);
                } else if (numero == 5) {
                    Intent o = new Intent(getApplicationContext(), Juego_tigre_corr.class);
                    startActivity(o);
                } else if (numero == 6) {
                    Intent o = new Intent(getApplicationContext(), itesm.mx.javafinal.Random6.Juego_nieto_corr.class);
                    startActivity(o);

                } else if (numero == 7) {
                    Intent o = new Intent(getApplicationContext(), Juego_perro.class);
                    startActivity(o);

                } else if (numero == 8) {
                    Intent o = new Intent(getApplicationContext(), Juego_vaca.class);
                    startActivity(o);

                } else if (numero == 9) {
                    Intent o = new Intent(getApplicationContext(), Juego_abril.class);
                    startActivity(o);

                } else if (numero == 10) {
                    Intent o = new Intent(getApplicationContext(), Juego_calabaza.class);
                    startActivity(o);

                } else {
                    Intent o = new Intent(getApplicationContext(), Juego_carne.class);
                    startActivity(o);

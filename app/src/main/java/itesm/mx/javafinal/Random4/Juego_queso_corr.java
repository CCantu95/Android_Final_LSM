...
import itesm.mx.javafinal.Random9.Juego_ardilla;
import itesm.mx.javafinal.juegoaleatorio.Juego_elote_corr;


public class Juego_queso_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_queso);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.queso);

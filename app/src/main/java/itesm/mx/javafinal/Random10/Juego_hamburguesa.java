...
public class Juego_hamburguesa extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_hamburguesa);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.hamburguesa);

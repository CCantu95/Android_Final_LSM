...
public class Juego_calabaza extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_calabaza);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.calabaza);

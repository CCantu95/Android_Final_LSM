...
import itesm.mx.javafinal.Random6.Juego_burro_corr;
...
public class Juego_refresco extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_refresco);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.refresco);

...
public class Juego_viernes extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_viernes);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.viernes);
        ...
        final Button button_c = (Button) findViewById(R.id.button_b);

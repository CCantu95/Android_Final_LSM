...
package itesm.mx.javafinal.Random8;
...
import itesm.mx.javafinal.Random4.Juego_pan_corr;
import itesm.mx.javafinal.Random5.Juego_tigre_corr;
import itesm.mx.javafinal.Random6.Juego_nieto_corr;
...
public class Juego_verde extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_verde);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.verde);

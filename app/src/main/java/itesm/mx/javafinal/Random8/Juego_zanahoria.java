...
import itesm.mx.javafinal.Random2.Juego_dulce_corr;
...
public class Juego_zanahoria extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_zanahoria);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.zanahoria);

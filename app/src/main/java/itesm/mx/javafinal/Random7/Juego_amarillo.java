...
public class Juego_amarillo extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_amarillo);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.amarillo);

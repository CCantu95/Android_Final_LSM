...
public class Juego_chocolate_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_chocolate);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.chocolate);

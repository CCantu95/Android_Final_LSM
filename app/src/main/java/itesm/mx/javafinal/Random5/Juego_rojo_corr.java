...
/**
 * Created by Jordi on 20/11/2017.
 */

public class Juego_rojo_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_rojo);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.rojo);

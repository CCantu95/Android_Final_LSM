...
import itesm.mx.javafinal.Random9.Juego_abuelo;
import itesm.mx.javafinal.juegoaleatorio.Juego_o_corr;


public class Juego_carne extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_carne);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.carne);

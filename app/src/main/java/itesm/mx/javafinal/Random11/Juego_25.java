...
package itesm.mx.javafinal.Random11;
...
public class Juego_25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego_25);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.n25);

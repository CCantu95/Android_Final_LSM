...
import itesm.mx.javafinal.Random9.Juego_azucar;
import itesm.mx.javafinal.juegoaleatorio.Juego_galleta_corr;


public class Juego_k extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_k);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.k);
        ...
        button_corr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (numero == 1) {
                    ...
                    Intent o = new Intent(getApplicationContext(), Juego_800_corr.class);//Ok
                    startActivity(o);
                } else if (numero == 3) {
                    Intent o = new Intent(getApplicationContext(), Juego_pollo_corr.class);//Ok
                    startActivity(o);

                } else if (numero == 4) {
                    Intent o = new Intent(getApplicationContext(), Juego_octubre_corr.class);//Ok
                    startActivity(o);
                } else if (numero == 5) {
                    Intent o = new Intent(getApplicationContext(), Juego_mama_corr.class);
                    startActivity(o);
                } else if (numero == 6) {
                    Intent o = new Intent(getApplicationContext(), Juego_cocacola_corr.class);//ok
                    startActivity(o);
                    ...
                    Intent o = new Intent(getApplicationContext(), Juego_azucar.class);//OK
                    startActivity(o);

                } else if (numero == 10) {
                    Intent o = new Intent(getApplicationContext(), Juego_hija.class);//OK
                    startActivity(o);

...
import itesm.mx.javafinal.Random3.Juego_jueves_corr;
...
public class Juego_jamaica extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_jamaica);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.jamaica);

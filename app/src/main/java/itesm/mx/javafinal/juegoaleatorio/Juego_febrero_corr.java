...
public class Juego_febrero_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_febrero);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.febrero);

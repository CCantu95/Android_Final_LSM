...
public class Juego_gusano_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_gusano);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.gusano);

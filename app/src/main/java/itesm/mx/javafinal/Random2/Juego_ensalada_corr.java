...
public class Juego_ensalada_corr extends AppCompatActivity {
    android.widget.VideoView VideoView;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juego_ensalada);
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.ensalada);
